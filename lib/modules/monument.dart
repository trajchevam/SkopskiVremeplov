...
class Monument {
  ...
  Monument(this.id, this.name, this.location, this.description, this.img, this.image);
  ...
  static List<Monument> getMonuments() {
    return [
      Monument(1, "Камен мост", Location.location1, "Description", "", null),
